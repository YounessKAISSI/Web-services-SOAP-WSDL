 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.app.enset.org/", wsdlLocation = "http://localhost:8787/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.app.enset.org/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.app.enset.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.app.enset.org/", "BanqueServicePort"), BanqueService.class, features);
    }
