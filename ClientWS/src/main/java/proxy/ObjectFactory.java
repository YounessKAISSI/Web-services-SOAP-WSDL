...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDH_QNAME = new QName("http://ws.app.enset.org/", "ConversionEuroToDH");
    private static final QName _ConversionEuroToDHResponse_QNAME = new QName("http://ws.app.enset.org/", "ConversionEuroToDHResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.app.enset.org/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.app.enset.org/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.app.enset.org/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.app.enset.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "ConversionEuroToDH")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "ConversionEuroToDHResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.app.enset.org/", name = "listComptesResponse")
